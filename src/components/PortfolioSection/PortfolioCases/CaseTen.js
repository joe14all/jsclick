...
const caseTen = {
  ...
  caseStudy: {
    carousel: [
      {
        video: OcclusalVideo,
        alt: "Occlusal function demonstration",
        caption: "Masticatory function validation",
        modality: "Clinical Video",
        tags: ["video", "occlusion", "function"],
      },

      {
        img: PrimaryFrontal,
        alt: "Primary impression frontal view",
        caption: "Initial tissue capture",
        modality: "Clinical Photography",
        tags: ["impression", "diagnostic"],
      },
      {
        img: TraysFrontal,
        alt: "Custom tray frontal view",
        caption: "Border molded special trays",
        modality: "Clinical Photography",
        tags: ["trays", "border-molding"],
      },
      {
        img: MasterFrontal,
